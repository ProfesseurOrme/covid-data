...
export const FR_HOSPITALIZATIONS = `https://data.widgets.dashboard.covid19.data.gouv.fr/hospitalisations.json`;
...
export const FR_FIRST_SHOT_VACCINE = `https://data.widgets.dashboard.covid19.data.gouv.fr/vaccins_premiere_dose.json`;

export const FR_GEOJSON_DEPARTMENTS = `https://france-geojson.gregoiredavid.fr/repo/departements.geojson`;

export const FR_GEOJSON_REGIONS = `https://france-geojson.gregoiredavid.fr/repo/regions.geojson`;